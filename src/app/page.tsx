export default function Home() {
  return (
    <main className="main">
      <div className="body border-8 border-red-500 h-screen">
        <div className="w-[1920px] h-[1080px] relative">
          <div className="w-[1920px] h-[1080px] left-0 top-0 absolute bg-neutral-200" />
          <div className="w-[342px] h-24 left-[789px] top-[863px] absolute">
      ...
      <div className="footer bg-slate-600 border-0 border-red-500 h-52">
        <p className="p-0.5">
